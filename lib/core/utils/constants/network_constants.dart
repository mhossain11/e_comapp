...
abstract class NetworkConstants{
  static const baseUrl = 'https://ecommerce.liberalsoft.net/user';
  static const baseUrlOne = 'https://ecommerce.liberalsoft.net';
  //static const category_Get = 'https://ecommerce.liberalsoft.net/product/';
  static const authority = 'ecommerce.liberalsoft.net';
  static const imageBaseUrl = '"https://ecommerce.liberalsoft.net/product_images';
